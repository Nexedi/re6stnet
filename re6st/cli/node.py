    ...
    try:
        ...
        try:
            ...
            cleanup.append(plib.router((my_ip, len(subnet)), ipv4,
                ...
                hmacFromKey(cache.babel_hmac_rand) if hasattr(cache,
                                                   'babel_hmac_rand') else None,
                hmacFromKey(cache.babel_hmac_rand_accept) if hasattr(
                                     cache, 'babel_hmac_rand_accept') else None,
